...
#include <iostream>
#include <string>
#include <set> // ordered, unique. 
// multiset // ordered, allows duplicates, included in the set header. 
#include <unordered_set> // unordered, unique, access with hash keys. 
// similarly, there is also an "unordered_multiset"
using namespace std;
...
int main() {
    ...
    if(it != set1.end()) {
        ...
        cout << "not found" << endl; 
        // When set.find(target) is not found, returns end of set as an alert.
    }
    print_set(set1);
