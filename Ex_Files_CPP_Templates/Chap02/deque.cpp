...
// A deque has similar UI as a vector.
// It supports random access. 
// However, a vector is optimized for random access, 
// while a deque is optimized as a double-ended queue. 
// The deque type is the default container for stacks and queues. 