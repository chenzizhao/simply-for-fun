...
#include <iostream>
#include <tuple> // note the "tuple" header file
#include <string>
using namespace std;
...
void print3tuple(T t) {
    ...
    // note how to access size of tuple.
    if(tsz != 3) return;
    cout << get<0>(t) << " : " << get<1>(t) << " : " << get<2>(t) << endl;
    // note how to access elements with indexing.
...
// Only included in C++ 11
// Tuple can have different sizes (compaired with pair). 