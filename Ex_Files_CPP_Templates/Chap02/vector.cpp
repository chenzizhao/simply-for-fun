...
int main() {
    ...
    v1.insert(v1.begin() + 5, 42); // pass in an iterator
    printv(v1);
    ...
    // constructors
    // There are just so many ways of constructing a vector. 
...
// The vector library is implemented as a template class. 
// You can put different types of elements into a vector. 
// Thus a vector is also called a container. 