...
int main() {
    ...
    a2 = {"one", "two", "three"};
    printa(a2);
    // Values for uninitialized elements are undetermined.
    // Always initialize the array, just like in C. 
    ...
    // direct access data
    int * ip1 = a1.data();
    // access the data with arr.data() function. 
...
// STL array type is a fixed size sequence container (of same type). 
// STL array is a wrapper of C array. 
// Analogy: fixed size list type. 
// Available in C++ 11. 
// Fast and efficient: contigious memory location. 