...
// Random access (ra) iterator is the most complete version of all iterators. 
// Offers all functionality of a C pointer. 
...
int main() {
    ...
    // Such indexing syntax is implemented using ra iterators. 
    it1 = v1.end() - 3;
